...
public class LogarithmicAxis extends ValueAxis<Number> {
	...
	// define two properties that will represent the log lower and upper bounds
	// of our axis.
	...
	// tick marks position that you want to display on the axis. You could find
	// my definition below. It's based on the number of minor tick and the
	// logarithmic formula.
	@Override
