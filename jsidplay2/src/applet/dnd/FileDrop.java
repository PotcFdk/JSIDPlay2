...
public class FileDrop {
				...
				public void drop(final java.awt.dnd.DropTargetDropEvent evt) {
					...
					try { // Get whatever was dropped
						...
						if (tr
							...
							if (listener != null) {
								listener.filesDropped(files, evt.getSource(), evt.getLocation());
							}
								...
								if (flavor.isRepresentationClassReader()) {
									...
									if (listener != null) {
										listener.filesDropped(createFileArray(
												br, out), evt.getSource(), evt.getLocation());
									}
	...
	protected static void log(final java.io.PrintStream out, final String message) { // Log
		// message
		// if
		// requested
		if (out != null) {
	...
	public interface Listener {
		 ...
		 * @param source components source
		 * @param point drop location
		 * @since 1.0
		 */
		public abstract void filesDropped(java.io.File[] files, Object source, Point point);
