...
public final class CollectionTreeModel implements TreeModel {
	/**
	 ...
	 * @param view
	 */
	public CollectionTreeModel(final File rootFile) {
	...
	private File[] getListOfFiles(File obj) {
		...
		File[] listFiles = ((File) obj).listFiles(fFileFilter);
		if (listFiles != null) {
