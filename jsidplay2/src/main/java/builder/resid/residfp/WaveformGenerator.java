...
public final class WaveformGenerator {
	...
	private byte calculateCurrentNoiseValue() {
		return (byte) ((noiseShiftRegister & 0x400000) >> 15 | (noiseShiftRegister & 0x100000) >> 14
				| (noiseShiftRegister & 0x010000) >> 11 | (noiseShiftRegister & 0x002000) >> 9
				| (noiseShiftRegister & 0x000800) >> 8 | (noiseShiftRegister & 0x000080) >> 5
				| (noiseShiftRegister & 0x000010) >> 3 | (noiseShiftRegister & 0x000004) >> 2);
	}
