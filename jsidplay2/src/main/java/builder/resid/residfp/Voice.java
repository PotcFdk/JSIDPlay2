...
public final class Voice {
	 ...
	 * stopped. You can hear this by routing a voice into filter (filter should be
	 * kept disabled for this) as the master level changes. This tunable determines
	 * this static offset and affects the volume of digis.
	 *
