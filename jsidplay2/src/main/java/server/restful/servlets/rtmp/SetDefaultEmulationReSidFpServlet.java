...
import static server.restful.common.CleanupPlayerTimerTask.setDefaultEmulationReSidFp;
...
public class SetDefaultEmulationReSidFpServlet extends JSIDPlay2Servlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			info("setDefaultEmulationReSidFp: RTMP stream of: " + uuid);
			setDefaultEmulationReSidFp(uuid);
		} catch (Throwable t) {
			error(t);
