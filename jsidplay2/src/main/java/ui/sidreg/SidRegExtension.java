...
public abstract class SidRegExtension implements SIDListener {
	...
	private final String description[] = new String[] { "VOICE_1_FREQ_L", "VOICE_1_FREQ_H", "VOICE_1_PULSE_L",
	...
	@Override
	public void write(final long time, final int chipNum, final int addr, final byte data) {
		if (fTime == 0) {
			fTime = time;
		}
