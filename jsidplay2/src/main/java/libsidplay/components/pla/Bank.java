...
public abstract class Bank {
	 ...
	 * unimplemented if it's logically/operationally impossible for writes to ever
	 * arrive to bank.
	 *
	...
	/**
	 * Bank read. Default throws a RuntimeException, so you probably should override
	 * this method, except if the Bank is only used in write context.
	 *
