...
public class Screen {
	private static final byte[] scrtab = { (byte) 0x80,
			(byte) 0x81,
			(byte) 0x82,
			(byte) 0x83,
			(byte) 0x84,
			...
			0x56,
			0x57, // 0x50 PQRSTUVW
			0x58, 0x59, 0x5a, 0x1b, (byte) 0xbf, 0x1d,
			0x1e,
			0x64, // 0x58 XYZ[\]^_
			0x27, 0x01, 0x02, 0x03, 0x04, 0x05,
			0x06,
			0x07, // 0x60 `abcdefg
			...
			0x20,
			0x20, // 0x98
			0x20, 0x21, 0x03, 0x1c, (byte) 0xbf, 0x59,
			0x5d,
			(byte) 0xbf, // 0xa0  ¡¢£¤¥¦§
			0x22, 0x43, 0x01, 0x3c, (byte) 0xbf, 0x2d,
			0x52,
			0x63, // 0xa8 ¨©ª«¬­®¯
			0x0f, (byte) 0xbf, 0x32, 0x33, 0x27, 0x15,
			(byte) 0xbf,
			(byte) 0xbf, // 0xb0 °±²³´µ¶·
			0x2c, 0x31, 0x0f, 0x3e, (byte) 0xbf, (byte) 0xbf, (byte) 0xbf,
			0x3f, // 0xb8 ¸¹º»¼½¾¿
			0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x43, // 0xc0 ÀÁÂÃÄÅÆÇ
			0x45, 0x45, 0x45, 0x45, 0x49, 0x49, 0x49, 0x49, // 0xc8 ÈÉÊËÌÍÎÏ
			(byte) 0xbf, 0x4e, 0x4f, 0x4f, 0x4f, 0x4f, 0x4f, 0x18, // 0xd0
																	// ÐÑÒÓÔÕÖ×
			0x4f, 0x55, 0x55, 0x55, 0x55, 0x59, (byte) 0xbf, (byte) 0xbf, // 0xd8
																			// ØÙÚÛÜÝÞß
			0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x03, // 0xe0 àáâãäåæç
			0x05, 0x05, 0x05, 0x05, 0x09, 0x09, 0x09, 0x09, // 0xe8 èéêëìíîï
			(byte) 0xbf, 0x0e, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f, (byte) 0xbf, // 0xf0
																			// ðñòóôõö÷
			0x0f, 0x15, 0x15, 0x15, 0x15, 0x19, (byte) 0xbf, 0x19 // 0xf8
																	// øùúûüýþÿ
	};
