...
public interface IFingerprintSection {
	 ...
	 *
	 * @param peakRange compares with the range of neighbors when taking the peak
	 *                  point
	 */
	...
	/**
	 * Getter of the frequency range at which the point pair is taken, in units of
	 * frequency.
	 *
	 * @return the frequency range at which the point pair is taken, in units of
	 *         frequency
	 */
	float[] getRangeFreq();

	/**
	 * Setter of the frequency range at which the point pair is taken, in units of
	 * frequency.
	 *
	 * @param rangeFreq the frequency range at which the point pair is taken, in
	 *                  units of frequency
	 */
	void setRangeFreq(float[] rangeFreq);

	/**
	 * Getter of divided subband, the value corresponds to the array index generated
	 * by the FFT.
	 *
	 * @return the divided subband, the value corresponds to the array index
	 *         generated by the FFT
	 */
	int[] getBand();

	/**
	 * Setter of divided subband, the value corresponds to the array index generated
	 * by the FFT.
	 *
	 * @param band divided subband, the value corresponds to the array index
	 *             generated by the FFT
	 */
