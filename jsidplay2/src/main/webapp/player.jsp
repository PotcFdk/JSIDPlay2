...
<script>
	new Vue({
		...
		methods: {
			fetchData: function () {
				axios.get('/jsidplay2service/JSIDPlay2REST/favorites', {
					auth: {
						username: 'jsidplay2',
						password: 'jsidplay2!'
					}	
