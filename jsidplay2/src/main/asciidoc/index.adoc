...
== JSIDPlay2 Server
link:https://haendel.ddns.net:8443/static/hvsc.vue[JSIDPlay2 HVSC Online Player]
...
link:{codebase}SIDBlasterUSB_HardSID-emulation-driver.tar.gz[Download SIDBlaster Linux conversion alpha]

Build commands for SIDBlaster Linux conversion:
