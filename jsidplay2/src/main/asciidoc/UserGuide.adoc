...
3.
Additionally we support SIDBlaster USB devices, e.g. link:http://crazy-midi.de/joomla/index.php/home/myprojects/elctronicp/58-sidblaster[SIDBlaster device TicTac Edition].
