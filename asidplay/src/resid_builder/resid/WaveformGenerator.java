...
public final class WaveformGenerator {
	...
	protected void setWftable(final int[][] tables, final int[] tables2, final byte[][] newWfdigital) {
		wftable = tables;
	 ...
	 */
	public int output(final WaveformGenerator ring_modulator) {
	...
	protected void writeCONTROL_REG(final WaveformGenerator ring_modulator, final byte control) {
		...
		if (test_next && !test) {
			accumulator = 0;
			accumulator_prev = 0;
			final int /* reg24 */bit19 = noiseShiftRegister >> 18 & 2;
